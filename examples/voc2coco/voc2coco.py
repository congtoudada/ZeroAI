...
# 格式转化前要将xml和图片全部放入annotations文件夹中，train2017、val2017里面为空。
...
if __name__ == '__main__':
    # classes = ['face', 'mask']  # 改为你需要检测的类别
    # classes = ['person', 'bucket', 'machine']  # 改为你需要检测的类别
    classes = ['head', 'face', 'mask']  # 改为你需要检测的类别
    # classes = ['0']  # 改为你需要检测的类别
