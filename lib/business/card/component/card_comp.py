...
from card.component.card_item import CardItem
from card.component.card_pool import CardPool


class CardComponent(BasedMOTComponent):
    def __init__(self, shared_data, config_path: str):
        super().__init__(shared_data)
        self.config: CardInfo = CardInfo(ConfigKit.load(config_path))
        # 定义变量
        self.pool: CardPool = CardPool(20, CardItem)
