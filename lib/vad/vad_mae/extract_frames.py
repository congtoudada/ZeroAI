...
if __name__ == '__main__':
    ...
    # 抽帧Avenue
    # phase = "test"
    # video_path = rf"H:\AI\dataset\VAD\Avenue\{phase}ing_videos"
    # img_path = rf"H:\AI\dataset\VAD\Avenue\{phase}\frames"
    ...
    # 抽帧Shanghaitech
    phase = "train"
    video_path = rf"H:\AI\dataset\VAD\ShanghaiTech\{phase}\videos"
    img_path = rf"H:\AI\dataset\VAD\ShanghaiTech\{phase}\frames"
    extract(video_path, img_path, step)
